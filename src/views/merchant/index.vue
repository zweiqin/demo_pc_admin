      ...
      <el-table :data="tableData.data" style="width: 100%" size="small" highlight-current-row>
        ...
        <el-table-column label="操作" min-width="120" fixed="right" align="center">
          <template v-slot="scope">
            ...
            <el-button v-if="scope.row.status === 1" type="text" size="small" class="mr10" @click="changeStatus(scope.row.mer_id,0)">禁用</el-button>
            <el-button v-else type="text" size="small" class="mr10" @click="changeStatus(scope.row.mer_id,1)">启用</el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  methods: {
    ...
    changeStatus(mer_id, type) {
      ...
      this.$confirm(msg, '提示', {
        ...
        UpdateMerStatus({ mer_id: mer_id, status: type })
          .then(() => {
