...
export default {
  ...
  methods: {
    // 打开新增窗口
    addClick() {
      // /** @namespace admin_menu_list.PcMenu  **/
      // /** @namespace admin_menu_list.AppMenu  **/
      ({ PcMenu: this.add_pc_data, AppMenu: this.add_phone_data } = this.admin_menu_list)
      this.pc_check = []
      this.mobile_check = []
      this.range = 0
    ...
    edit(e) {
      ...
      this.editForm.rules_mobile = e.rules_mobile
